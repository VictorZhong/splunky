...
- Add DB-backed persistence with Flyway under `splunky-service/src/main/resources/db/migration`.
- Replace `InMemoryLlmCredentialStore` with encrypted DB-backed `spky_llm_credential` storage.
